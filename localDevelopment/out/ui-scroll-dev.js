		...
		return {
			...
			compile: function (elementTemplate, attr, linker) {
				return function ($scope, element, $attr, controllers) {
					...
					var updateItems = function (locator, newItem) {
					...
					var deleteItems = function (locator) {
					...
					var insertItems = function (locator, item) {
					...
					var processing = $attr.processing;
					processing = getValueChain($scope, processing);
					if (processing && angular.isObject(processing)) {
